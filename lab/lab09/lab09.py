def insert_into_all(item, nested_list):
    ...
    for b in nested_list: #go through list
        for elements in b: #go through nested lists within list
            return [b[1:].insert(item, 0)]
...
def subseqs(s):
    ...
    if len(s)==0:
        ...
        #________________ #use insert_to_all some how?
        return []+[subseqs(s[1:])]
...
def insert(link, value, index):
    ...
    >>> print(link)
    <9001 1 2 3>
    # Make sure you are using mutation! Don't create a new linked list.
    >>> link is other_link
    True
    >>> insert(link, 100, 2)
    >>> print(link)
